...
const createServerMenu = (): ActionRowBuilder<ButtonBuilder>[] => {
  return [
    new ActionRowBuilder<ButtonBuilder>()
      ...
      .addComponents(ServerOption.create({label: "2", style: ButtonStyle.Primary, id: "Admin"}))
      .addComponents(ServerOption.create({label: "3", style: ButtonStyle.Primary, id: "Mod"}))
      .addComponents(ServerOption.create({label: "4", style: ButtonStyle.Primary, id: "Discovery"}))
