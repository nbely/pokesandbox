...
const Profile: React.FC = () => {
  ...
  return (
    <div className="profile">
      {!profile?.username ? <LoadingOutlined className="loadSpinner" /> :
        <Typography>
            ...
            <div className="panel info">
              <div className="basicInfo component">
                ...
                <div className="componentBody">
                  <Title level={5}>Name: {profile.firstName} {profile.nickname ? "'" + profile.nickname + "' " : ''}{profile.lastName}</Title>
              ...
              <div className="rivalInfo component">
                ...
                <Divider />
                <div className="componentBody">
                  <Title level={5}>Name: {profile.rival.firstName} {profile.rival.lastName}</Title>
                  <Title level={5}>Age: {profile.rival.age}</Title>
                  <Title level={5}>Gender: {profile.rival.gender}</Title>
                  <Title level={5}>Party:</Title>
                  {profile.rival.team.map((name: any, index: number)=><img key={index} src={imgUrl(name)} alt={name}/>)}
                </div>
              </div>
            </div>
            <div className="panel belongings">
              <div className="inventory component">
                ...
                <div className="componentBody">
                  ...
                  <Title level={5}>Badges: {profile.badges.join(', ') || "None"}</Title>
                  <Title level={5}>Key Items: {profile.keyItems.join(', ') || "None"}</Title>
              ...
              <div className="party component">
                ...
                <div className="componentBody">
                  <ul className="slotList">
                    {profile.party.map((pkmn: any, index: number) => <li key={pkmn.species}>
                      ...
                      {pkmn.pokemon && (<ul>
                        ...
                        <li>Set Moves: 
                          <table className="movesTable">
                            <tbody>
                              {pkmn.setMoves.map((move: any, index: number) => 
