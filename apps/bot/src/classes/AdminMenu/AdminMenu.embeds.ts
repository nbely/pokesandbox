...
import type { MenuCommandOptions } from '../types';

export const getServerInitializedEmbed = async <C extends MenuCommandOptions = MenuCommandOptions>(menu: AdminMenu<C>) => {
